...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('lti_toolurl', array('toolurl', get_string('toolurl', 'basiclti'), 'basiclti'));
...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('lti_sendname', array('sendname', get_string('sendname', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_instructorchoicesendname', array('instructorchoicesendname', get_string('instructorchoicesendname', 'basiclti'), 'basiclti'));

        $mform->addElement('select', 'lti_sendemailaddr', get_string('sendemailaddr', 'basiclti'), $options);
        $mform->setDefault('lti_sendemailaddr', '0');
        $mform->setHelpButton('lti_sendemailaddr', array('sendemailaddr', get_string('sendemailaddr', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_instructorchoicesendemailaddr', array('instructorchoicesendemailaddr', get_string('instructorchoicesendemailaddr', 'basiclti'), 'basiclti'));
...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('lti_acceptgrades', array('acceptgrades', get_string('acceptgrades', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_instructorchoiceacceptgrades', array('instructorchoiceacceptgrades', get_string('instructorchoiceacceptgrades', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_allowroster', array('allowroster', get_string('allowroster', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_instructorchoiceallowroster', array('instructorchoiceallowroster', get_string('instructorchoiceallowroster', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_allowsetting', array('allowsetting', get_string('allowsetting', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_instructorchoiceallowsetting', array('instructorchoiceallowsetting', get_string('instructorchoiceallowsetting', 'basiclti'), 'basiclti'));
...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('lti_allowinstructorcustom', array('allowinstructorcustom', get_string('allowinstructorcustom', 'basiclti'), 'basiclti'));
...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('lti_organizationid', array('organizationid', get_string('organizationid', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_organizationurl', array('organizationurl', get_string('organizationurl', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('lti_organizationdescr', array('organizationdescr', get_string('organizationdescr', 'basiclti'), 'basiclti'));
        */
...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('lti_launchinpopup', array('launchinpopup', get_string('launchinpopup', 'basiclti'), 'basiclti'));
