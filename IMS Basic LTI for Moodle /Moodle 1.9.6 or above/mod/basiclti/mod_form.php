    ...
    function definition() {
        ...
        if (empty($typename)){
            ...
            if (!empty($this->_instance)){
                $basiclti = get_record('basiclti','id',$this->_instance);
            ...
            $basicltitype = get_record('basiclti_types','rawname',$typename);
...
//-------------------------------------------------------------------------------
    ...
    /// Adding the optional "intro" and "introformat" pair of fields
        $mform->addElement('htmleditor', 'intro', get_string('basicltiintro', 'basiclti'));
...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('instructorchoicesendname', array('sendname', get_string('sendname', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('instructorchoicesendemailaddr', array('sendemailaddr', get_string('sendemailaddr', 'basiclti'), 'basiclti'));
...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('instructorchoiceacceptgrades', array('instructorchoiceacceptgrades', get_string('acceptgrades', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('instructorchoiceallowroster', array('allowroster', get_string('allowroster', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('instructorchoiceallowsetting', array('allowsetting', get_string('allowsetting', 'basiclti'), 'basiclti'));
...
//-------------------------------------------------------------------------------
        ...
        // $mform->setHelpButton('launchinpopup', array('launchinpopup', get_string('launchinpopup', 'basiclti'), 'basiclti'));
        ...
        $mform->setHelpButton('debuglaunch', array('debuglaunch', get_string('debuglaunch', 'basiclti'), 'basiclti'));
